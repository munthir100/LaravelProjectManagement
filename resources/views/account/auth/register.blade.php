...
<head>
    ...
    @include("layouts.shared.includes.title-meta",["title" => __("Sign Up")])
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form class="needs-validation" novalidate action="{{ route('account.register') }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="name" placeholder="{{__('Enter your name')}}" required>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" id="useremail" name="email" placeholder="{{__('Enter email address')}}" required>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control pe-5 password-input" onpaste="return false" name="password" placeholder="{{__('Enter password')}}" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-12 text-muted fst-italic">{{__('By registering you agree to the Velzon')}} <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium">{{__('Terms of Use')}}</a></p>
                                                </div>
                                                ...
                                                <div id="password-contain" class="p-3 bg-light mb-2 rounded">
                                                    ...
                                                    <p id="pass-lower" class="invalid fs-12 mb-2">{{__('At')}} <b>{{__('lowercase')}}</b> {{__('letter (a-z)')}}</p>
                                                    <p id="pass-upper" class="invalid fs-12 mb-2">{{__('At least')}} <b>{{__('uppercase')}}</b> {{__('letter (A-Z)')}}</p>
                                                    <p id="pass-number" class="invalid fs-12 mb-0">{{__('A least')}} <b>{{__('number')}}</b> (0-9)</p>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">{{__('Already have an account ?')}} <a href="{{ route('account.login') }}" class="fw-semibold text-primary text-decoration-underline">{{__('Signin')}}</a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
